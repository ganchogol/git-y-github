...
// button.style = 'background: ${isAuthorized ? background : 'blue'}; color: ${color}'
...
// const names = ['sergio', 'manuel', 'alexander']
...
// const names = ['sergio', 'manuel', 'alexander']
// const newNames = ['muriel','james','falcao']
